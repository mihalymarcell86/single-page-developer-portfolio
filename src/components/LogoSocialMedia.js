    ...
    <>
      ...
      <menu className={scss.social_media}>
        ...
        >
          ...
          >
            <title id="github_title">Github</title>
            <path
              fill="currentColor"
              fillRule="evenodd"
        ...
        >
          <svg
            ...
            height="23"
            role="img"
            aria-labelledby="fm_title"
          >
            <title id="fm_title">Frontend Mentor</title>
            <path
              fill="currentColor"
